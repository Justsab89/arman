...
pool.getConnection(function(err, connection) {
    ...
    var sql = ' INSERT INTO product (name, size, number, print_exp, print_profit, rizprint_exp, rizprint_profit, offprint_exp, offprint_profit, digprint_exp, digprint_profit, paper_type, paper_exp, cut_exp, cut_profit, interval ) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
